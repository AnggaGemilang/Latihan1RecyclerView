...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager mLayoutManager;private List<Song> songList;
    ...
    String[] names = {"I Took A Pill In Ibiza", "7 Years", "Pillow Talk", "Work From Home",
            ...
            "Justin Bieber", "G-Eazy x Bebe Rexha", "DNCE", "Ariana Grande", "Florida",
...
//add song list
        for (int i = 0; i < names.length; i++) {Song song = new Song(names[i], singers[i], i + 1, pics[i]);
            songList.add(song);
        }
